...
urlpatterns = [
    ...
    path('course_student/<str:course_id>/module/<int:module_id>/', views.module_detail, name='module_detail'),
    path('course/<str:course_id>/module/<int:module_id>/', views.module_detail_prof, name='module_detail_prof'),
